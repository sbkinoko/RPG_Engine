...
import static com.sbkinoko.sbkinokorpg.gameparams.GameParams.EFFECT_TYPE_BUFF;
import static com.sbkinoko.sbkinokorpg.gameparams.GameParams.EFFECT_TYPE_CONDITION;
import static com.sbkinoko.sbkinokorpg.gameparams.GameParams.EFFECT_TYPE_CONTINUE_ATK;
import static com.sbkinoko.sbkinokorpg.gameparams.GameParams.EFFECT_TYPE_ESCAPE;
import static com.sbkinoko.sbkinokorpg.gameparams.GameParams.EFFECT_TYPE_HEAL;
import static com.sbkinoko.sbkinokorpg.gameparams.GameParams.EFFECT_TYPE_REVIVE;
import static com.sbkinoko.sbkinokorpg.gameparams.GameParams.EFFECT_TYPE_STEEL;
...
public class List_Skill extends List_Item {
    static private final SkillData[] skillDataList = {
            ...
            new SkillData("NULL",  canNotInEither, 0, 0, 0, 0, 0),
            ...
            new ConditionSkillData("麻痺にする", canInBattle, EFFECT_TYPE_CONDITION,
                    ...
                    1, 0),
            new SkillData("蘇生", canInEither, EFFECT_TYPE_REVIVE, 0, 50, 1, 5),
            ...
            new SkillData("MAX回復", canInEither, EFFECT_TYPE_HEAL, 0, 9999, 1, 5),
            ...
            new SkillData("全体回復", canInEither, EFFECT_TYPE_HEAL, 0, 10, maxMonsNum, 50),//10
            ...
            new SkillData("sample8", canNotInEither, EFFECT_TYPE_ATK, 0, 15, 1, 0),
            new SkillData("sample9", canNotInEither, EFFECT_TYPE_ATK, 0, 15, 1, 0),
            new SkillData("sample10",canNotInEither, EFFECT_TYPE_ATK, 0, 15, 1, 0),

            new SkillData("sample11", canNotInEither, EFFECT_TYPE_ATK, 0, 15, 1, 0),//20
            new SkillData("sample12", canNotInEither, EFFECT_TYPE_ATK, 0, 15, 1, 0),
            new SkillData("sample13", canNotInEither, EFFECT_TYPE_ATK, 0, 15, 1, 0),
